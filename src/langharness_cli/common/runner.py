...
from langharness_cli.contracts import CommandSpec
...
class CLIRunner:
    ...
    def build_parser(self) -> argparse.ArgumentParser:
        parser = argparse.ArgumentParser(prog="langharness")
        parser.add_argument("--provider", help="LLM provider configured in langharness.toml")
        parser.add_argument(
            "--dir", help="configuration and log directory (default: ~/.langharness)"
        )
