...
from langharness_core.contracts import CheckpointerProvider
...
@Property("_path", "plugin.checkpoint.path", "langharness_checkpoints.sqlite3")
class SQLiteCheckpointerPlugin:
    ...
    def __init__(self) -> None:
        ...
        self._ranking = 1000
        self._path = "langharness_checkpoints.sqlite3"
