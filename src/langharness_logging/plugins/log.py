...
@Property("_directory", "plugin.log.directory", "~/.langharness")
@Property("_logger_name", "plugin.log.name", "langharness")
@Property("_filename", "plugin.log.filename", "langharness.log")
@Property("_captured_logger_names", "plugin.log.capture", "")
class FileLogPlugin:
    def __init__(self) -> None:
        self._directory = "~/.langharness"
        self._logger_name = "langharness"
        self._filename = "langharness.log"
